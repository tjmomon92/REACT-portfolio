            ...
            <Container>
                <Row className="align-items-center">
                    <Col className="left-about" xs={12} md={6} xl={7}>
                        ...
                        <p>I am a Texas based full-stack web developer, with a passion for UI design and creation who finds a calling in application development for just about anything. My focus revolves around clean and efficient code, while ensuring accessibility and ease-of-use to guarantee that anyone can utilize my creations. I am a tenacious and quick learner, and there is nothing that I love more than to learn something new about my chosen craft.</p>
                    </Col>
                    <Col xs={12} md={6} xl={5}>
